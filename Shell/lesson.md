...
* Use built-in help
* Create, modify, move, and remove files
* Utilize tab completion and other shortcuts
* Create simple pipelines
* Create and run simple bash script


## Commands we will cover:
* whoami
* pwd
* ls, ls -F -a
* cd (relative vs. absolute path)
